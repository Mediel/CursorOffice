...
- nepravidelné mrkání, gesta i vsedě a autonomní volnočasové chování: hotový hlavní agent zůstává v kanceláři, volní agenti střídají lounge, poradu, kuchyňku a volná místa, mávají majiteli, protahují se, pijí kávu a vytvářejí dvou- až čtyřčlenné konverzace na gauči, kolem poradního stolu i ve stojících hloučcích; délka posezení, gest, pití, rozhovorů i střídání mluvčích se mění v přirozených rozsazích pro každou další aktivitu,
