...
export const ownerDeskFixture: DeskFixture = {
  id: 'owner-desk', x: -7.05, z: -4.05, width: 2.55, accent: 0xf4b85c, seat: ownerDesk
};

export const agentDeskFixtures: readonly DeskFixture[] = [
  desk('work-a', -3.95, -4.55, 1.72, 0x39d98a),
  desk('work-b', -1.65, -4.55, 1.72, 0xffbd4a),
  desk('work-c', 0.65, -4.55, 1.72, 0x9d7cff),
  desk('work-d', -3.95, -2.12, 1.72, 0x4da3ff),
  desk('work-e', -1.65, -2.12, 1.72, 0x43b9c8),
  desk('work-f', 0.65, -2.12, 1.72, 0xe880b5),
  desk('debug-a', 5.1, -4.5, 1.78, 0xff5f6d),
  desk('debug-b', 7.55, -4.5, 1.78, 0xff8b63)
];
...
export const partitionWalls: readonly WallFixture[] = [
  ...
  wall('work-south-a', 4.6, 0.18, -3.05, -0.75, 0x1c3541),
  wall('work-south-b', 2.9, 0.18, 2.2, -0.75, 0x1c3541),
...
export const navigationAnchors: readonly THREE.Vector3[] = [
  ...
  point(-4.75, -1.2), point(-2.75, -1.2), point(-0.65, -1.2), point(2.75, -1.2),
  point(-4.8, -3.35), point(-2.8, -3.35), point(-0.55, -3.35), point(2.75, -3.35),
  point(-4.75, -5.45), point(-2.75, -5.45), point(-0.5, -5.45), point(2.7, -5.4),
  point(2.35, 0), point(4.45, 0), point(6.2, -0.25), point(6.2, -1.18),
  point(4.35, -1.25), point(5.55, -2.8), point(7.05, -2.8), point(8.65, -2.8),
...
export const officePois: readonly OfficePoi[] = [
  ...agentDeskFixtures.map((item, index) => poi(`desk-${index}`, 'desk', item.seat, 'workSeat', Math.PI)),
...
export const officeObstacles: readonly OfficeObstacle[] = [
  ...
  obstacle('plant-work', 2.55, 3.25, -5.8, -5.05),
  obstacle('plant-debug', 8.58, 9.3, -5.8, -5.05),
...
export function targetForAgent(status: AgentStatus, index: number): AgentDestination {
  switch (status) {
    case 'working': return destination(slot(agentDesks, index), 'workSeat', Math.PI);
...
function desk(id: string, x: number, z: number, width: number, accent: number): DeskFixture {
  return { id, x, z, width, accent, seat: new THREE.Vector3(x, 0, z + 0.9) };
}
